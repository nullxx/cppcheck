...
cppcheck.js: $(LIBOBJ) $(CLIOBJ) $(EXTOBJ)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -o $@ $^ $(LIBS) $(LDFLAGS) $(RDYNAMIC) -s MODULARIZE=1 -s ENVIRONMENT='web' -s EXPORT_ES6=1 -s 'EXPORTED_RUNTIME_METHODS=["callMain","FS"]' -s 'ALLOW_MEMORY_GROWTH=1' -s 'INITIAL_MEMORY=2048mb' -fwasm-exceptions

all:	cppcheck.js testrunner
